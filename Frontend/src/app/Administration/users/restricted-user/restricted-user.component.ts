...
@Component({
  ...
  styleUrls: ['./restricted-user.component.scss']
})
export class RestrictedUserComponent {
  tableRows: User[] ;
  totalRows: number;
  tableColumns = [
    { name: 'LastName', prop: 'LastName', flexGrow: 2 },
    { name: 'FirstName', prop: 'FirstName', flexGrow: 0.7 },
